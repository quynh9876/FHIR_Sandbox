...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      column: patient_id { field: patient.id }
      column: event_date { field: analytics.admission_date }
      column: organization_id { field: analytics.organization_name }
      ...
      filters: {
        field: analytics.count_covid_confirmed
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_covid_suspected
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_patient_death
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_patient_home_healthcare
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_inpatient_visit
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      column: patient_id { field: patient.id }
      column: event_date { field: analytics.discharge_date }
      column: organization_id { field: analytics.organization_name }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_staffed_bed_encounters
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_icu_bed_encounters
        value: ">0"
      }
    }
  }
...
#   }
  ...
  derived_table: {
    explore_source: fhir_hcls {
      ...
      filters: {
        field: analytics.count_patient_snf
        value: ">0"
      }
    }
  }
...
view: final_patient_status {
  derived_table: {
    ...
    create_process: {
      ...
      sql_step:
      INSERT INTO ${SQL_TABLE_NAME} (snapshot_date, patient_id)
      SELECT snapshot_date, patient_id FROM ${patient_events_by_calendar_date.SQL_TABLE_NAME}
      ;;
      ...
      FROM (
      SELECT patient_id, generated_date as snapshot_date, location_status
      FROM ${patient_status_location.SQL_TABLE_NAME}
      ) n
      WHERE i.patient_id = n.patient_id
      ...
      FROM (
        SELECT patient_id, snapshot_date, covid_status, covid_suspected_status
      ...
      FROM (
        SELECT patient_id, generated_date as snapshot_date, bed_status
      ...
      FROM (
      SELECT patient_first_event.patient_id, patient_calendar.snapshot_date
      , ROW_NUMBER() OVER (PARTITION BY patient_first_event.patient_id order by patient_calendar.snapshot_date asc) as days_since_first_event
      FROM ${patient_events_by_calendar_date.SQL_TABLE_NAME} as patient_calendar
      INNER JOIN
      (
        SELECT patient_id, MIN(event_date) as date_of_first_event
        FROM ${patient_events_covid_positive.SQL_TABLE_NAME}
        WHERE event_type in ('positive_test','suspected_covid')
        GROUP BY 1
      ) AS patient_first_event ON patient_calendar.patient_id =  patient_first_event.patient_id
...
## Location Counts
  ...
  measure: count_patients_location_hospital { group_label: "Location Counts" type: count_distinct sql: ${patient_id} ;; filters: [location_status: "Hospital"] }
  measure: count_patients_location_ambulatory { group_label: "Location Counts" type: count_distinct sql: ${patient_id} ;; filters: [location_status: "Home Monitoring, Home Recovering, Home"] }
  measure: count_patients_location_death { group_label: "Location Counts" type: count_distinct sql: ${patient_id} ;; filters: [location_status: "Death"] }
  measure: count_patients_location_snf { group_label: "Location Counts" type: count_distinct sql: ${patient_id} ;; filters: [location_status: "SNF"] }

## COVID Counts

  measure: count_patients_covid_suspected { group_label: "COVID Counts" type: count_distinct sql: ${patient_id} ;; filters: [covid_consolidated_status: "Suspected"] }
  measure: count_patients_covid_confirmed { group_label: "COVID Counts" type: count_distinct sql: ${patient_id} ;; filters: [covid_consolidated_status: "Positive"] }
  measure: count_patients_covid_not_suspected { group_label: "COVID Counts" type: count_distinct sql: ${patient_id} ;; filters: [covid_consolidated_status: "Not Suspected"] }

## Patient Status Counts

  measure: count_patients_status_1_ambulatory { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "1 - Ambulatory"] }
  measure: count_patients_status_2_inpatient { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "2 - Inpatient"] }
  measure: count_patients_status_3_inpatient_icu { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "3 - Inpatient ICU"] }
  measure: count_patients_status_4_discharged_snf { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "4 - Discharged to SNF"] }
  measure: count_patients_status_5_discharged_home { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "5 - Discharged to Home"] }
  measure: count_patients_status_6_death { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "6 - Death"] }
  measure: count_patients_status_99_other { group_label: "Patient Status Counts" type: count_distinct sql: ${patient_id} ;; filters: [patient_status: "99 - Other"] }
