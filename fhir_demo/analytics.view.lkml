...
# view: ccf_test_bind_all_filters {derived_table: { explore_source: fhir_ccf { bind_all_filters: yes column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCF" }}} dimension: id {} dimension: value {}}
...
# view: ccf_test_no_filter {derived_table: { explore_source: fhir_ccf { column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCF" }}} dimension: id {} dimension: value {}}

## Condition - list of relevant ICD10 codes by patient for last 365 days
# view: icd10_codes_by_ccf_id { derived_table: { datagroup_trigger: once_daily explore_source: fhir_ccf_pre {column: value { field: patient__identifier.value } column: code { field: condition__code__coding.code } filters: { field: patient__identifier__type__coding.code value: "CCF" } filters: { field: encounter__period.start_date value: "365 days" }}} dimension: value {} dimension: code {}}


## Island Hopping
view: identifier_encounter_csn_island_hopping {derived_table: {explore_source: fhir_ccf { column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "CSN" } filters: { field: analytics.admission_date value: "365 days"}}} dimension: id {} dimension: value {}}
view: identifier_encounter_contacttype_island_hopping {derived_table: {explore_source: fhir_ccf { column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "CONTACTTYPE" } filters: { field: analytics.admission_date value: "365 days"}}} dimension: id {} dimension: value {}}
view: identifier_patient_ccf_island_hopping {derived_table: { explore_source: fhir_ccf { column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCF" } filters: { field: analytics.admission_date value: "365 days"}}} dimension: id {} dimension: value {}}
view: identifier_location_si_island_hopping {derived_table: { explore_source: fhir_ccf { column: id { field: encounter.id } column: name { field: location.name } filters: { field: location__physical_type__coding.code value: "si" } filters: { field: analytics.admission_date value: "365 days"}}} dimension: id {} dimension: name {}}
...
view: identifier_encounter_har {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "HAR" }}} dimension: id {} dimension: value {}}
view: identifier_encounter_contacttype {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "CONTACTTYPE" }}} dimension: id {} dimension: value {}}
view: identifier_encounter_bedid {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "BEDID" }}} dimension: id {} dimension: value {}}
view: identifier_encounter_adtype {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "ADTYPE" }}} dimension: id {} dimension: value {}}
view: identifier_encounter_chargeslip {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: encounter__identifier.value } filters: { field: encounter__identifier__type__coding.code value: "CHARGESLIP" }}} dimension: id {} dimension: value {}}

## Patient

view: identifier_patient_epi {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "EPI" }}} dimension: id {} dimension: value {}}
view: identifier_patient_ccf {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCF" }}} dimension: id {} dimension: value {}}

view: identifier_patient_memrn {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "MEMRN" }}} dimension: id {} dimension: value {}}
view: identifier_patient_fla_ccf {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "FLA-CCF" }}} dimension: id {} dimension: value {}}
view: identifier_patient_sb {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "SB" }}} dimension: id {} dimension: value {}}
view: identifier_patient_dl {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "DL" }}} dimension: id {} dimension: value {}}
view: identifier_patient_fvmrn {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "FVMRN" }}} dimension: id {} dimension: value {}}
view: identifier_patient_irisreg {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "IRISREG" }}} dimension: id {} dimension: value {}}
view: identifier_patient_cchs_er_hch {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCHS-ER" }}} dimension: id {} dimension: value {}}
view: identifier_patient_cchs_wr_mmh {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCHS-WR" }}} dimension: id {} dimension: value {}}
view: identifier_patient_avmrn {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "AVMRN" }}} dimension: id {} dimension: value {}}
view: identifier_patient_agmrn {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "AGMRN" }}} dimension: id {} dimension: value {}}
view: identifier_patient_agldmrn {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "AGLDMRN" }}} dimension: id {} dimension: value {}}
view: identifier_patient_lumrn {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "LUMRN" }}} dimension: id {} dimension: value {}}
view: identifier_patient_cpc_agambmr {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CPC-AGAMBMR" }}} dimension: id {} dimension: value {}}
view: identifier_patient_cpc_aghs {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CPC-AGHS" }}} dimension: id {} dimension: value {}}
view: identifier_patient_cchs_er_sph {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CCHS-ER" }}} dimension: id {} dimension: value {}}
view: identifier_patient_mychart {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "MYCHART" }}} dimension: id {} dimension: value {}}
view: identifier_patient_cpc_rfpi {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "CPC-RFPI" }}} dimension: id {} dimension: value {}}
view: identifier_patient_selmed_epi {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "SELMED-EPI" }}} dimension: id {} dimension: value {}}
view: identifier_patient_selmed_fh {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date }  column: id { field: encounter.id } column: value { field: patient__identifier.value } filters: { field: patient__identifier__type__coding.code value: "SELMED-FH" }}} dimension: id {} dimension: value {}}

## Observation

## code.coding.code
view: identifier_observation_himprimarycsn {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: nested_structs.observation__value__quantity__value } filters: {field: observation__code__coding.code value: "HIMPRIMARYCSN"}}} dimension: id {} dimension: value {type: number}}
view: identifier_observation_dischdisposition {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: nested_structs.observation__value__quantity__value } filters: {field: observation__code__coding.code value: "DISCHDISPOSITION"}}} dimension: id {} dimension: value {type: number}}
view: identifier_observation_apptprocedure {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: nested_structs.observation__value__quantity__value } filters: {field: observation__code__coding.code value: "APPTPROCEDURE"}}} dimension: id {} dimension: value {type: number}}

## value.quantity. unit
view: identifier_observation_kg {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: nested_structs.observation__value__quantity__value } filters: {field: nested_structs.observation__value__quantity__unit value: "kg"}}} dimension: id {} dimension: value {type: number}}
view: identifier_observation_cm {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: nested_structs.observation__value__quantity__value } filters: {field: nested_structs.observation__value__quantity__unit value: "cm"}}} dimension: id {} dimension: value {type: number}}

## kg, cm

## Practitioner

view: identifier_practitioner_ccf {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "CCF" }}} dimension: id {} dimension: value {}}
view: identifier_practitioner_ser_dr_no {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "SER-DR-NO" }}} dimension: id {} dimension: value {}}
view: identifier_practitioner_npi {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "NPI" }}} dimension: id {} dimension: value {}}
...
view: identifier_practitioner_atndrw {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "ATNDRW" }}} dimension: id {} dimension: value {}}
...
view: identifier_practitioner_agambdrno {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "AGAMBDRNO" }}} dimension: id {} dimension: value {}}
view: identifier_practitioner_fvludrno {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "FVLUDRNO" }}} dimension: id {} dimension: value {}}
...
view: identifier_practitioner_acdrno {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "ACDRNO" }}} dimension: id {} dimension: value {}}
view: identifier_practitioner_mmdrno {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: value { field: practitioner__identifier.value } filters: { field: practitioner__identifier__type__coding.code value: "MMDRNO" }}} dimension: id {} dimension: value {}}

## Location

view: identifier_location_lvl {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: name { field: location.name } filters: { field: location__physical_type__coding.code value: "lvl" }}} dimension: id {} dimension: name {}}
view: identifier_location_bu {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: name { field: location.name } filters: { field: location__physical_type__coding.code value: "bu" }}} dimension: id {} dimension: name {}}
view: identifier_location_bd {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: name { field: location.name } filters: { field: location__physical_type__coding.code value: "bd" }}} dimension: id {} dimension: name {}}
view: identifier_location_ro {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: name { field: location.name } filters: { field: location__physical_type__coding.code value: "ro" }}} dimension: id {} dimension: name {}}
view: identifier_location_si {derived_table: { explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: name { field: location.name } filters: { field: location__physical_type__coding.code value: "si" }}} dimension: id {} dimension: name {}}
...
# ## Method 1: Build a
#
# view: identifier_condition_fk {derived_table: {explore_source: fhir_ccf { bind_filters: { from_field: analytics.admission_date to_field: analytics.admission_date } column: id { field: encounter.id } column: condition_id { field: encounter__diagnosis__condition.condition_id }}} dimension: id {} dimension: condition_id {}}
#
