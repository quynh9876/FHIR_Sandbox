...
view: procedure__shr_action_performed_context_extension__shr_action_status_extension__value {
  label: "Procedure"
  dimension: code {
    group_label: "{{ _view._name }}"
    type: string
...
view: procedure__shr_action_performed_context_extension__shr_action_status_extension {
  label: "Procedure"
  dimension: value {
    group_label: "{{ _view._name }}"
    hidden: yes
...
view: procedure__shr_action_performed_context_extension {
  label: "Procedure"
